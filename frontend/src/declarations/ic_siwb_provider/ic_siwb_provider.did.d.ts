...
export type RuntimeFeature = { 'IncludeUriInSeed' : null } |
  { 'DisablePrincipalToBtcMapping' : null } |
  { 'DisableBtcToPrincipalMapping' : null };
...
export type SignMessageType = { 'Bip322Simple' : null } |
  { 'ECDSA' : null };
...
export interface _SERVICE {
  ...
  'update_settings' : ActorMethod<[SettingsInput], undefined>,
}
